angular.module('reg')
    ...
    .constant('DASHBOARD', {
        ...
        ADMITTED_AND_CAN_CONFIRM_TITLE: 'Please make sure to confirm within a week of acceptance to secure your seat, or else it may be passed to someone else. Check your spam and junk folders if you don’t hear from us in two weeks, and add contact@designlablive.com to your safe list.',
